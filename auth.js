...
export const ROLE_PERMISSIONS = {
  ...
  reports:             ['super_admin', 'chief', 'internal_affairs', 'training_bureau', 'agency_admin', 'supervisor'],
  'officer-profile':   ['super_admin', 'chief', 'internal_affairs', 'training_bureau', 'agency_admin', 'supervisor'],
  'ia-cases':          ['super_admin', 'chief', 'internal_affairs', 'agency_admin'],
  pips:                ['super_admin', 'chief', 'internal_affairs', 'training_bureau', 'agency_admin', 'supervisor'],
  'in-person-reviews': ['super_admin', 'chief', 'internal_affairs', 'training_bureau', 'agency_admin', 'supervisor'],
  admin:               ['super_admin', 'agency_admin'],
  roster:              ['super_admin', 'chief', 'agency_admin', 'supervisor'],
